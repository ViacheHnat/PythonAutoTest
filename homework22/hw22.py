...
app.config['JWT_SECRET_KEY'] = 'super-secret1'  # Змініть на свій секретний ключ
jwt = JWTManager(app)
...
# @pytest.mark.parametrize("authorization", ["asd"], scope='class')
...
# @pytest.mark.parametrize('qwe', ['BMW'])
